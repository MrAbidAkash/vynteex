...
export default function CTASection() {
  ...
  return (
    <section className="text-center py-12 pb-24 ">
      ...
      <button onClick={handleBuyNow} className="bg-[linear-gradient(135deg,var(--secondary),var(--accent))] text-white px-6 py-3 rounded-full text-xl mt-5 cursor-pointer animate-pulse">
        Buy Now & Save Today
      </button>
    </section>
  )
